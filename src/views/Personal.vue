    ...
    <div class="text-container">
      ...
      <div class="balance">
        <div class="balance-top">
          <div id="rechargechang">
            余额 {{ $store.state.count }}书币 + 0书币
          </div>
          <router-link to="/Per/personinfo">
            <div class="recharge">
              充值
            </div>
          </router-link>
    ...
    <div class="bottom-container">
      <div class="bottomc-msg">
        <div class="bottomc-msgline">
          <div>
            <img src="@/assets/images/mseeage.png">
          </div>
          <div class="bottomc-msgtext">
            消息
          </div>
        </div>
        <div>
...
export default {
    ...
    methods: {
        createcode() {
            let account = sessionStorage.getItem("accounturl")
            account = JSON.parse(account)
            console.log(account)
            if (account !== null) {
                document.getElementById("countcg").innerHTML =
          "<div>" + account + "</div>"
                document.getElementById("dataportrait").className = "data-portraited"
            }
        },
        BrowseRecord(){
            this.$router.push({ path: "/Per/browere" })
        },
    }
}
</script>