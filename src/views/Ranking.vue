    ...
    <div class="ranking">
      <div class="ranking-table">
        <div class="male-table">
          ...
          <div
            v-for="(item,idx) in maleRank"
            :key="item.id"
            class="male-ranking"
          >
            <router-link :to="'/ranks/malerankDetail/' + maleRank[idx]._id">
              {{ item.title }}
            </router-link>
          </div>
        </div>
        ...
        <div class="female-table">
          ...
          <div
            v-for="(item,idx) in femaleRank"
            :key="item.id"
            class="female-ranking"
          >
            <router-link :to="'/ranks/femalerankDetail/' + femaleRank[idx]._id">
              {{ item.title }}
            </router-link>
          </div>
        </div>
